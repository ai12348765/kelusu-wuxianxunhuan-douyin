export type Role = '防护' | '输出' | '治疗';
export type BattlePhase = 'intro' | 'normal' | 'intervention' | 'victory' | 'defeat';
...
export const investigatorConfig = [
  { id: 'luchen', name: '陆沉', role: '防护' as Role, maxHp: 4620, maxEnergy: 100, dps: 520, color: '#65c9ff' },
  { id: 'fangjin', name: '方烬', role: '输出' as Role, maxHp: 4110, maxEnergy: 100, dps: 1120, color: '#ff5e5e' },
  { id: 'ningkui', name: '宁葵', role: '治疗' as Role, maxHp: 3580, maxEnergy: 100, dps: 360, color: '#70ffe7' },
];
